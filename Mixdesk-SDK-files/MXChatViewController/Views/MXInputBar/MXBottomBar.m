...
- (instancetype)initWithFrame:(CGRect)frame contentView:(MXInputContentView *)contentView; {
    if (self = [super initWithFrame:frame]) {
        ...
        _buttonGroupBar = [[MXButtonGroupBar alloc] init];
        ...
        if (!self.contentView) {
            _contentView = [[MXInputContentView alloc] init];
        }
...
-(void)setContentViewDelegate:(id<MXInputContentViewDelegate>)contentViewDelegate
{
    self.contentView.delegate = contentViewDelegate;
}

-(void)setButtonGroupDelegate:(id<MXButtonGroupBarDelegate>)buttonGroupDelegate
{
    self.buttonGroupBar.delegate = buttonGroupDelegate;
}

-(id<MXButtonGroupBarDelegate>)buttonGroupDelegate
{
