...
-(void)commonInit
{
    ...
    [self setImage:[MXAssetUtil imageFromBundleWithName:@"radio_nomal"] forState:UIControlStateNormal];
    [self setImage:[MXAssetUtil imageFromBundleWithName:@"radio_selected"] forState:UIControlStateSelected];
}
