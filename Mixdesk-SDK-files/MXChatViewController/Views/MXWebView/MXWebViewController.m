...
@interface MXWebViewController()<WKNavigationDelegate>
...
//    self.webView.dataDetectorTypes = UIDataDetectorTypeNone; daizqtodo
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[MXAssetUtil backArrow] style:UIBarButtonItemStylePlain target:self action:@selector(close)];
