...
@interface MXPageScrollItemView()
...
@implementation MXPageScrollItemView
...
- (void)updateViewFrameWith:(CGFloat)maxWidth {
    self.bounds = CGRectMake(0, 0, maxWidth, self.pageMaxSize * (kMXPageItemYMargin + kMXPageItemContentHeight));
    ...
    [self.contentViewArr enumerateObjectsUsingBlock:^(UIButton *  _Nonnull btn, NSUInteger idx, BOOL * _Nonnull stop) {
        itemY += kMXPageItemYMargin;
        btn.frame = CGRectMake(kMXPageItemLeftAndRightMargin, itemY, maxWidth - 2 * kMXPageItemLeftAndRightMargin, kMXPageItemContentHeight);
    }];
}
...
- (void)setupItems {
    ...
    [self.contentList enumerateObjectsUsingBlock:^(NSString *  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        itemY += kMXPageItemYMargin;
        btn.frame = CGRectMake(kMXPageItemLeftAndRightMargin, itemY, weakSelf.bounds.size.width - 2 * kMXPageItemLeftAndRightMargin, kMXPageItemContentHeight);
        itemY += kMXPageItemContentHeight;
