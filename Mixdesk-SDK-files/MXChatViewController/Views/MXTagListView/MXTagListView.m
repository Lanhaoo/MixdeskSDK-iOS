 ...
 * tag标签的内边距top
 */
static CGFloat const kMXTagItemTopEdgeInsets = 4.0;
/**
 * tag标签的内边距bottom
 */
static CGFloat const kMXTagItemBottomEdgeInsets = 4.0;
/**
 * tag标签的内边距Left
 */
static CGFloat const kMXTagItemLeftEdgeInsets = 8.0;
/**
 * tag标签的内边距Right
 */
static CGFloat const kMXTagItemRightEdgeInsets = 8.0;
/**
 * tag标签的垂直间距
 */
static CGFloat const kMXTagItemVerticalSpacing = 10.0;
/**
 * tag标签的水平间距
 */
static CGFloat const kMXTagItemHorizontalSpacing = 5.0;

@interface MXTagListView ()
...
-(void)updateLayoutWithMaxWidth:(CGFloat)maxWidth {
    if (self.cacheTitleArr && maxWidth != self.cacheMaxWidth) {
        ...
        for (int i = 0; i < self.cacheTitleArr.count; i++) {
            ...
            if (tagTempWidth != 0) {
                tempWidth += kMXTagItemHorizontalSpacing;
            }
            // 判断是否需要换行
            if (tagTempWidth + tempWidth <= maxWidth) {
                ...
                height += kMXTagItemVerticalSpacing + btnHeight;
            }
...
-(UIButton *)getTagItemWithTitle:(NSString *)title maxWidth:(CGFloat)maxWidth  {
    ...
    btn.contentEdgeInsets = UIEdgeInsetsMake(kMXTagItemTopEdgeInsets, kMXTagItemLeftEdgeInsets, kMXTagItemBottomEdgeInsets, kMXTagItemRightEdgeInsets);
    [btn sizeToFit];
...
-(void)clickButton:(UIButton *)btn {
    ...
    if (self.mxTagListSelectedIndex) {
        self.mxTagListSelectedIndex(index);
    }
}
