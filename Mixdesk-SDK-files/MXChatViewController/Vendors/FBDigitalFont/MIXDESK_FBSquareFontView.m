#import "MIXDESK_FBSquareFontView.h"
#import "MIXDESK_FBFontSymbol.h"
#import "MIXDESK_FBSquareFont.h"

@interface MIXDESK_FBSquareFontView ()
@property (nonatomic, copy) NSArray *symbols;
@end

@implementation MIXDESK_FBSquareFontView
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (i = 0; i < [self.symbols count]; i++) {
        [MIXDESK_FBSquareFont drawSymbol:[[self.symbols objectAtIndex:i] intValue]
