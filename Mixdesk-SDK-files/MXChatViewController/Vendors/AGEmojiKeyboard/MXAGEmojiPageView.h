...
@protocol MXAGEmojiPageViewDelegate;

@interface MXAGEmojiPageView : UIView

@property (nonatomic, assign) id<MXAGEmojiPageViewDelegate> delegate;
...
@protocol MXAGEmojiPageViewDelegate <NSObject>
