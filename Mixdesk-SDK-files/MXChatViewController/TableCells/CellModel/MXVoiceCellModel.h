...
/**
 * MXVoiceCellModel定义了语音消息的基本类型数据，包括产生cell的内部所有view的显示数据，cell内部元素的frame等
 * @warning MXVoiceCellModel必须满足MXCellModelProtocol协议
 */
@interface MXVoiceCellModel : NSObject <MXCellModelProtocol>
