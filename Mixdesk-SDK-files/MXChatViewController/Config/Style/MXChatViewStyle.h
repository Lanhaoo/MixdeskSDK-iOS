...
static NSString *const MXBlueColor = @"#17c7d1";
static NSString *const MXSilverColor = @"#c6cbd0";

typedef NS_ENUM(NSUInteger, MXChatViewStyleType) {
    MXChatViewStyleTypeDefault,
    MXChatViewStyleTypeBlue,
    MXChatViewStyleTypeGreen,
    MXChatViewStyleTypeDark,
};

@interface MXChatViewStyle : NSObject
...
/**
 *  设置底部评价的按钮图片；
 *  @param evaluationSenderImage 评价发送按钮image
 *  @param evaluationSenderHighlightedImage 评价发送按钮高亮的image
 */
 @property (nonatomic, strong) UIImage *evaluationSenderImage;
 @property (nonatomic, strong) UIImage *evaluationSenderHighlightedImage;
