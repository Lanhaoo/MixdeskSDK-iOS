...
@implementation MXPreChatSelectionCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        [self setSelectionStyle:(UITableViewCellSelectionStyleNone)];
        self.textLabel.font = [UIFont systemFontOfSize:14];
        self.textLabel.textColor = [UIColor mx_colorWithHexString:ebonyClay];
...
@implementation MXPrechatSingleLineTextCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.textField.textColor = [UIColor mx_colorWithHexString:ebonyClay];
        self.textField.placeholder = [MXBundleUtil localizedStringForKey:@"pre_chat_form_input"];
...
@implementation MXPreChatMultiLineTextCell
...
@implementation MXPreChatCaptchaCell
...
@implementation MXPreChatSectionHeaderView
...
- (void)setupUI {
    ...
    self.tintColor = [UIColor mx_colorWithHexString:silver];
}
...
- (void)setShouldMark:(BOOL)shouldMark {
    self.tintColor = shouldMark ? [UIColor redColor] : [UIColor mx_colorWithHexString:silver];
}
...
- (void)updateUI {
    ...
    self.typeLabel.text = self.formItem.type == MXPreChatFormItemInputTypeMultipleSelection ? @"(多选)" : @"";
...
- (void)setFormItem:(MXPreChatFormItem *)formItem {
    _formItem = formItem;
    [self updateUI];
}
